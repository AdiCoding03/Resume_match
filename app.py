...
st.header("SKILL MATCHING APPLICATION :blue[AI assisted skill matching tool]",divider='green')

st.subheader('Tips to use the tool')

tips = '''* Upload your resume in sidebar (PDF only).
* Copy and paste the job description for the job you are applying for.
...
if job_desc:
    if pdf_doc is None:
        st.write("You forgot to upload the resume")
    else:
